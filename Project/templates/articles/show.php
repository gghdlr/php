...
<div class="card" style="width: 18rem;">
  <div class="card-body">
    ...
    <a href="/yurlov/Project/www/comment/create/<?=$article->getId();?>" class="btn btn-primary">add comment</a>
  </div>
</div>
<h3>Comments</h3>
...
<div class="card" style="width: 18rem;">
  <div class="card-body">
    ...
    <a href="/yurlov/Project/www/comment/edit/<?=$comment->getId();?>" class="/yurlov/Project/www/">edit comment</a>
    <a href="/yurlov/Project/www/comment/delete/<?=$comment->getId();?>" class="/yurlov/Project/www/">delete comment</a>
  </div>
</div>
<?php endforeach;?>
<?php
